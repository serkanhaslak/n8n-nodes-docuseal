...
describe('DocusealTrigger.node', () => {
	let docusealTrigger: DocusealTrigger;

	beforeEach(() => {
		docusealTrigger = new DocusealTrigger();
	...
	describe('Node Properties', () => {
		...
		it('should have correct properties structure', () => {
			...
			const eventTypeProperty = docusealTrigger.description.properties.find(
	...
	describe('Integration', () => {
		it('should be properly configured for n8n', () => {
			// Check that the node follows n8n conventions
